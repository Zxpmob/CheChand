 ...
 * Supabase یا مستقیم از CoinGecko) در حافظه اضافه می‌شوند.
 */
...
const SITE_ITEMS = [
  ...
  // ---------------- رمزارز (CoinGecko یا Supabase) ----------------
  // رمزارزها دیگر اینجا تعریف نمی‌شوند — به‌صورت پویا هنگام دریافت داده
  // (از Supabase یا مستقیم از CoinGecko) در همین‌جا (در حافظه) اضافه
  // می‌شوند؛ کد مربوطه در data.js، توابع applyCoinGeckoMarkets() و
